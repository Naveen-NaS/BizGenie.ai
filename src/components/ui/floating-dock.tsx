  ...
  return (
    <Link target="_blank" href={href}>
      <motion.div
        ...
        className="aspect-square rounded-full bg-gray-950 dark:bg-neutral-800 flex items-center justify-center relative"
      >
        <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="px-2 py-0.5 whitespace-pre rounded-md bg-gray-700 border dark:bg-neutral-800 dark:border-neutral-900 dark:text-white border-gray-600 text-neutral-50 absolute left-1/2 -translate-x-1/2 -bottom-8 w-fit text-xs"
          >
            {title}
          </motion.div>
        )}
